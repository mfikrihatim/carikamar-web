...
class Property_facilities extends CI_Controller
{
	...
	public function SavePropertyFasilitas()
	{
		...
		if ($fasilitas_properti_detail_id == null) $fasilitas_properti_detail_id =  [];
		
		$add['fasilitas_properti_detail_id'] = json_encode($fasilitas_properti_detail_id);
		...
		$add['deleted_date'] = null;
		$add['status_id'] = 1;
		// var_dump($add['fasilitas_properti_detail_id']); die;
