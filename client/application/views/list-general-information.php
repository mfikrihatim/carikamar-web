                            ...
                            <div class="col-6" id="main-contact">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <input type="text" name="nama_lengkap" id="nama_lengkap" class="form-control" value='<?= empty($DataMasterKontak->nama_lengkap) ? '' : $DataMasterKontak->nama_lengkap ?>' style="font-weight: bold;" />
