                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-7">
                                                <div class="form-check form-check-inline">
                                                    <input <?=  $key->flag_included_breakfast == 1 ? "checked" : "" ?> class="form-check-input" type="radio" name="flag_included_breakfast[]<?= $key->id ?>" id="exampleRadios1<?= $key->id ?>" value="1" />
                                                    <label class="form-check-label" for="exampleRadios1<?= $key->id ?>">
                                                        Yes
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input <?=  $key->flag_included_breakfast == 0 ? "checked" : "" ?> class="form-check-input" type="radio" name="flag_included_breakfast[]<?= $key->id ?>" id="exampleRadios1<?= $key->id ?>" value="0" />
                                                    <label class="form-check-label" for="exampleRadios1<?= $key->id ?>">
                                                        No
                                                    </label>
                                                </div>
...
$(document).ready(function() {
    $("#simpan").on('click', function() {
        ...
        $.ajax({
            ...
            error: (err) => {
                alert('500 Error Internal Server')
                console.log(err)
            }
        });
    })
