 ...
 <div class="content-wrapper">
     ...
     <div class="content-header">
         <div class="container-fluid">
             <div class="row mb-2">
                 <div class="col-sm-6">
                     <h1 class="m-0 text-dark">Edit Data Fasilitas Properti</h1>
                 </div>
                 <!-- <div class="col-sm-6">
         ...
         <div class="container-fluid">
             ...
             <div class="box">
                 <div class="box-header with-border">
                     <div class="row">
                         <div class="col-12">
                             <form action="<?php echo site_url('Fasilitas_Properti/UpdateDataFasilitasProperti'); ?>" method="post" role="form" enctype="multipart/form-data">
                                 <div class="card-body">
                                         ...
                                         <select class="form-control" name="fasilitas_properti_detail_id" required>
                                             ...
                                             <?php
                                                foreach ($DataFasilitasPropertiDetail as $ReadDS) {
                                                    if ($ReadDS->id == $detail['fasilitas_properti_detail_id']) {
                                                ?>
                                     ...
                                     <div class="row">
                                             ...
                                             <div class="form-group">
                                                 ...
                                                 <div class="input-group">
                                                     <label class="form-check-label ml-4 mr-3">
                                                         <input class="form-check-input" type="checkbox" name="flag_free" value="1" <?php if ($detail['flag_free'] == '1') {
                                                                                                                                        echo 'checked';
                                                                                                                                    } ?> id="submit" /> 1
                                         ...
                                         <div class="col-6">
                                             <div class="form-group">
                                                 ...
                                                 <div class="input-group">
                                                     <label class="form-check-label ml-4 mr-3">
                                                         <input class="form-check-input" type="checkbox" name="flag_fullday" value="1" <?php if ($detail['flag_fullday'] == '1') {
                                                                                                                                            echo 'checked';
                                                                                                                                        } ?> id="submit" /> 1
                                                     </label>
                                                 </div>
