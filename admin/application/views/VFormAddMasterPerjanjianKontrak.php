 ...
 <div class="content-wrapper">
     ...
     <div class="content-header">
         <div class="container-fluid">
             <div class="row mb-2">
                 <div class="col-sm-6">
                     <h1 class="m-0 text-dark">Tambah Data Perjanjian Kontrak</h1>
                 </div>
                 <!-- <div class="col-sm-6">
         ...
         <div class="container-fluid">
             ...
             <div class="box">
                 <div class="box-header with-border">
                     <div class="row">
                         <div class="col-12">
                             <form action="<?php echo site_url('Master_Perjanjian_Kontrak/AddDataMasterPerjanjianKontrak'); ?>" method="post" role="form">
                                 <div class="card-body">
