         ...
         <div class="container-fluid">
             ...
             <div class="box">
                 <div class="box-header with-border">
                     <div class="row">
                         <div class="col-12">
                             <form action="<?php echo site_url('Welcome/EditPengurusRt'); ?>" method="POST" role="form">
                                 <div class="card-body">
                                     <div class="form-group">
                                         <label>Nama Lengkap</label>
                                         <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>" class="form-control">
                                         <input name="nama_lengkap" type="text" class="form-control" value="<?php echo $datas['nama_lengkap'] ?>">
                                     </div>
                                     <div class="form-group">
                                         <label>Jabatan</label>
                                     ...
                                     <div class="form-group">
                                         <label>Status</label>
                                         <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>" class="form-control">
                                         <input name="status" type="text" class="form-control" value="<?php echo $datas['status'] ?>">
                                     </div>
