 ...
 <div class="content-wrapper">
     ...
     <div class="content-header">
         <div class="container-fluid">
             <div class="row mb-2">
                 <div class="col-sm-6">
                     <h1 class="m-0 text-dark">Tambah Data Anggota Keluarga</h1>
                 </div>
                 <!-- <div class="col-sm-6">
         ...
         <div class="container-fluid">
             ...
             <div class="box">
                 <div class="box-header with-border">
                     <div class="row">
                         <div class="col-12">
                             <form action="<?php echo site_url('Welcome/AddAnggotaKeluarga'); ?>" method="post" role="form">
                                 <div class="card-body">
                                     ...
                                     <div class="form-group">
                                         <label>No Urut</label>
                                         <input name="no_urut" type="number" class="form-control" placeholder="No Urut">
                                     </div>
                                     <div class="form-group">
                                     ...
                                     <div class="form-group">
                                         ...
                                         <input name="nama_anggota_keluarga" type="text" class="form-control" placeholder="Jumlah Keluarga">
                                     </div>
                                     <div class="form-group">
                                     ...
                                     <div class="form-group">
                                         <label>Kitap</label>
                                         <input name="kitap" type="number" class="form-control" placeholder="Kitap">
                                     </div>
                                     <div class="form-group">
                                         <label>Negara</label>
