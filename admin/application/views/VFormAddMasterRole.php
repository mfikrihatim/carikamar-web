 ...
 <div class="content-wrapper">
     ...
     <div class="content-header">
         <div class="container-fluid">
             <div class="row mb-2">
                 <div class="col-sm-6">
                     <h1 class="m-0 text-dark">Tambah Master Role</h1>
                 </div>
                 <!-- <div class="col-sm-6">
         ...
         <div class="container-fluid">
             ...
             <div class="box">
                 <div class="box-header with-border">
                     <div class="row">
                         <div class="col-12">
                             <form action="<?php echo site_url('Master_Role/AddDataMasterRole'); ?>" method="post"
                                 enctype="multipart/form-data">
                                 <div class="card-body">

                                     <div class="form-group">
                                         <label>Nama Role</label>
                                         <input name="nama_role" type="text" class="form-control"
