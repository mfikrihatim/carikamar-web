 ...
 <div class="content-wrapper">
     ...
     <div class="content-header">
         <div class="container-fluid">
             <div class="col-sm-6">
                 <h1 class="m-0 text-dark">Data Master Bank</h1>
             </div>
         </div><!-- /.container-fluid -->
     </div>
     <!-- /.content-header -->
                         ...
                         <div class="col-12">
                             <div class="card">
                                 <div class="card-header">
                                     <a href="<?php echo site_url('Master_bank/VFormAddMasterBank'); ?>"
                                         class="btn btn-success">
                                         Tambah Data Master Bank
                                     </a>
                                 </div>
                                 <!-- /.card-header -->
                                 <div class="card-body table-responsive p-3" style="height: 100%;">
                                     ...
                                     <table id="example1" class="table table-bordered table-striped">
                                         ...
                                         <tbody>
                                             <?php
                                                if (!empty($MasterBank)) {
                                                    foreach ($MasterBank as $index => $ReadDS) {
                                                        $index = $index + 1;
                                                ?>
                                             <tr>
