 ...
 <div class="content-wrapper">
     ...
     <div class="content-header">
         <div class="container-fluid">
             <div class="row mb-2">
                 <div class="col-sm-6">
                     <h1 class="m-0 text-dark">Edit Master Bank</h1>
                 </div>
         ...
         <div class="container-fluid">
             ...
             <div class="box">
                 <div class="box-header with-border">
                     <div class="row">
                         <div class="col-12">
                             <form action="<?php echo site_url('Master_bank/UpdateDataMasterBank'); ?>"
                                 ...
                                 <div class="card-body">
                                     <div class="form-group">
                                         ...
                                         <input type="text" class="form-control" name="nama_bank"
                                             value="<?php echo $detail['nama_bank']; ?>" placeholder="Masukan nama bank">
                                     </div>
