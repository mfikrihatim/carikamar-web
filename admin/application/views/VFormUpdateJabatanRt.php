         ...
         <div class="container-fluid">
             ...
             <div class="box">
                 <div class="box-header with-border">
                     <div class="row">
                         <div class="col-12">
                             <form action="<?php echo site_url('Welcome/EditJabatanRt'); ?>" method="POST" role="form">
                                 <div class="card-body">
                                     <div class="form-group">
                                         <label>Nama Jabatan</label>
                                         <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>" class="form-control">
                                         <input name="nama_jabatan" type="text" class="form-control" value="<?php echo $datas['nama_jabatan'] ?>">
                                     </div>
