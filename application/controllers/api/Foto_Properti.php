...
class Foto_Properti extends RestController
{
    ...
    public function index_get()
    {
        ...
        if (isset($header['Authorization'])) {
            if ($header['Authorization'] == $this->token) {
                if (isset($_GET['id'])) {
                    $query = $this->MSudi->GetDataWhere2('foto_properti', 'status_id', 1, 'id', $_GET['id'])->result();
                    $this->response([
                        'status' => 200,
                        'message' => 'success',
                        'data' => $query
                    ...
                    $query = $this->MSudi->GetDataWhereCount('foto_properti', 'status_id', 1);
                    $this->response([
                        'status' => 200,
                        'message' => 'success',
                        'data' => $query
                    ...
                    $query = $this->MSudi->GetDataWhere('foto_properti', 'status_id', 1)->result();
                    $this->response([
                        'status' => 200,
        ...
        if (isset($_POST['id'])) {
            ...
            if (isset($header['Authorization'])) {
                if ($header['Authorization'] == $this->token) {
                            ...
                            if (!empty($_FILES['files']['name'][$i])) {
                                ...
                                try {
                                    ...
                                    if ($this->upload->do_upload('file')) {
                                        ...
                                        $filename = site_url('uploads/foto_properti/') . $uploadData['file_name'];
                    ...
                    $query = $this->MSudi->AddData('foto_properti', $insert);
                    $this->response([
                        'status' => 200,
                        'message' => 'success',
                        'data' => $query
    ...
    public function update()
    {
        ...
        if (isset($header['Authorization'])) {
            if ($header['Authorization'] == $this->token) {
                ...
                $query = $this->MSudi->UpdateData('foto_properti', 'id', $update['id'], $update);
                $this->response([
                    'status' => 200,
                    'message' => 'success',
                    'data' => $query
    ...
    public function index_delete()
    {
        ...
        if (isset($header['Authorization'])) {
            if ($header['Authorization'] == $this->token) {
                ...
                $query = $this->MSudi->UpdateData('foto_properti', 'id', $delete['id'], $delete);
                $this->response([
                    'status' => 200,
